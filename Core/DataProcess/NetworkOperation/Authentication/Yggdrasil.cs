...
namespace RMA70_LauncherLib.Core.DataProcess.NetworkOperation.Authentication
{
    ...
    public partial class Yggdrasil
    {
        ...
        public async Task<AuthResult> RefreshAsync(string accessToken)
        {
    ...
    public partial class Yggdrasil
    {
        public AuthResult Auth() => AuthAsync().GetResult();
        public AuthResult Refresh(string accessToken) => RefreshAsync(accessToken).GetResult();
